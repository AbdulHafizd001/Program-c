...
void tampilkanFooter() {
    cout << "=========================================================================================" << endl;
    cout << "==================== { Terima kasih telah mengunjungi CAFE ENJOY } ======================" << endl;
    ...
    if (totalHarga > 0) {
        ...
        switch (pilihanPembayaran) {
            case 1:
                ...
                break;
            case 2:
                cout << "\nAnda memilih pembayaran kartu kredit." <<endl<<"Pesanan Anda sedang diproses. Mohon menunggu." <<endl;
                break;
            case 3:
                cout << "\nAnda memilih pembayaran e-wallet." <<endl<<"1
				Pesanan Anda sedang diproses. Mohon menunggu." << endl;
                break;
            default:
